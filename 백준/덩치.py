...
# 문제
# 우리는 사람의 덩치를 키와 몸무게, 이 두 개의 값으로 표현하여
# 그 등수를 매겨보려고 한다. 어떤 사람의 몸무게가 x kg이고
# 키가 y cm라면 이 사람의 덩치는 (x, y)로 표시된다.
...
# 여러분은 학생 N명의 몸무게와 키가 담긴 입력을 읽어서 각 사람의 덩치 등수를
# 계산하여 출력해야 한다.
#
# 입력
...
# cnt = 1
# for j in range(1,n):
#     if lst[j-1][0] > lst[j][0] and lst[j-1][1] > lst[j][1]:
#         lst[j].append(j+1)
#         cnt += 1
#     else:
#         lst[j].append(lst[j-1][3])
#
